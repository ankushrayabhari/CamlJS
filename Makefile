...
MODULES=tokenizer grammar parser ast_converter curry_optimizer unused_binding_optimizer tail_rec_optimizer call_squasher optimizer renderer file_helper
